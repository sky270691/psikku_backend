...
public interface TestPackageService {
    ...
    PackageWithOrderDto getOrderingPackageByVoucher(String voucher);

    void sendStopSignal(String voucher, Integer position);
    void sendRestSignal(String voucher, boolean rest);
}
