...
@Service
public class IstObjectiveResultTestCalculator implements UniqueResultTestCalculator {
    ...
    @Autowired
    public IstObjectiveResultTestCalculator(TestService testService,
